...
describe("stats table export", function() {
    ...
    xit("should be possible to get relative frequencies as CSV", () => browser.get(browser.params.url + "#?corpus=suc2,suc3&search=lemgram|gå..vb.1&result_tab=2").then(function() {
    ...
    return xit("should be possible to get absolute frequencies as TSV with multiple reduce parameters", () => browser.get(browser.params.url + "#?result_tab=2&stats_reduce=word,msd,saldo&corpus=suc2,suc3&search=word|gå ut").then(function() {
