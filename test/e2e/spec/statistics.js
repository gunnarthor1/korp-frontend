...
describe("stats table", function() {
    ...
    it("should show the correct rows and columns", () => browser.get(browser.params.url + "#?corpus=suc2,suc3&search=lemgram|gå..vb.1&result_tab=2").then(function() {
    ...
    it("should return expected  results for reduce on word", () => browser.get(browser.params.url + "#?corpus=suc2,suc3&search=lemgram|gå..vb.1&result_tab=2").then(function() {
        const rows = element.all((By.css('.slick-row')))
    ...
    it("should work to open arc diagram with the correct result", () => browser.get(browser.params.url + "#?corpus=suc2,suc3&search=lemgram|gå..vb.1&result_tab=2&stats_reduce=lemma").then(function() {
        browser.sleep(1000)
    ...
    it("should be possible to do a KWIC search on the rows, multi-word", () => browser.get(browser.params.url + "#?result_tab=2&stats_reduce=saldo&corpus=suc2,suc3&search=word|gå ut").then(function() {
        let rows
        browser.sleep(500)
    ...
    return it("should be possible to reduce on more than one attribute", () => browser.get(browser.params.url + "#?result_tab=2&stats_reduce=word,msd,lex&corpus=suc2,suc3&search=word|gå ut").then(function() {
