 ...
 */
describe("lemgram autocomplete", () => it("should show for default mode", () => browser.get(browser.params.url).then(function() {
...
describe("lemgram suggestions", () => it("should be clickable and show correct output", () => browser.get(browser.params.url + "#?corpus=suc2").then(function() {
    const input = element.all(By.css("#simple_text input")).first();
    input.sendKeys("gå");
